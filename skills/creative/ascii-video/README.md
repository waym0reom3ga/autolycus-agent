...
Built for [Lycus Agent](https://github.com/NousResearch/lycus-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/lycus-agent/skills/creative/ascii-video`](https://github.com/NousResearch/lycus-agent/tree/main/skills/creative/ascii-video) via PR.
