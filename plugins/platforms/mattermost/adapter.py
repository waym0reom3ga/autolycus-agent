...
required — uses aiohttp which is already a Lycus dependency.
...
def interactive_setup() -> None:
    ...
    ``lycus_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Lycus delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # lycus_cli/setup.py::_setup_mattermost function.
