# Lycus Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.autolycus/plugins/lycus-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.autolycus/plugins/lycus-achievements/scan_checkpoint.json`.
