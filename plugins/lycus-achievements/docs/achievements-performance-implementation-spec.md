# Lycus Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.autolycus/plugins/lycus-achievements/state.json` (existing unlock state)
  - `~/.autolycus/plugins/lycus-achievements/scan_snapshot.json` (new)
  - `~/.autolycus/plugins/lycus-achievements/scan_checkpoint.json` (new)
