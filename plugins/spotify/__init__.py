...
``_check_spotify_available()`` — when the user has not run ``lycus auth
spotify``, the tools remain registered (so they appear in ``lycus
...
The Spotify auth flow (``lycus auth spotify``), CLI plumbing, and docs
