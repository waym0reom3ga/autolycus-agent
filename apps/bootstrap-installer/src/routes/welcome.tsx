 ...
 * 99% of users; the rest will use the CLI installer with a -LycusHome
 * flag. Showing %LOCALAPPDATA% to grandma is developer-brain.
 */
export default function Welcome() {
  return (
    <div className="lycus-fade-in flex h-full flex-col items-center justify-center gap-10 px-12 py-10">
