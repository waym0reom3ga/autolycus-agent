...
import { getLycusConfigRecord, type LycusGateway, saveLycusConfig } from '@/lycus'
import { useI18n } from '@/i18n'
import { Wrench } from '@/lib/icons'
import { cn } from '@/lib/utils'
import { notify, notifyError } from '@/store/notifications'
import { $activeSessionId } from '@/store/session'
import type { LycusConfigRecord } from '@/types/lycus'
...
function getServers(config: LycusConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveLycusConfig(nextConfig)
