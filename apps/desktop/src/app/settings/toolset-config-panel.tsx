...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/lycus'
 ...
 * log inline — the GUI equivalent of the install step `lycus tools` runs
