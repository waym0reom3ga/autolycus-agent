...
import type { OAuthProvider } from '@/types/lycus'
    ...
    listOAuthProviders.mockResolvedValue({
      providers: [
        provider('qwen-oauth', true, {
          ...
          disconnect_hint: 'Use `lycus auth add qwen-oauth` or that provider\'s CLI to remove it.',
