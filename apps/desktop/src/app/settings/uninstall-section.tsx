...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The Lycus agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the Lycus agent, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the Lycus agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the Lycus agent, and all of your config, chats, secrets, and logs',
...
export function UninstallSection() {
  ...
  useEffect(() => {
    let alive = true
    const bridge = window.autolycusDesktop?.uninstall
    if (!bridge) {
      setLoading(false)
      return
    }
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Uninstall Lycus</p>
