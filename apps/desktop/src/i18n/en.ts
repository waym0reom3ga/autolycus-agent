...
export const en: Translations = {
  ...
  boot: {
    ready: 'Lycus Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Lycus settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingLycusDesktop: 'Starting Lycus Desktop…'
    },
    errors: {
      backgroundExited: 'Lycus background process exited.',
      backgroundExitedDuringStartup: 'Lycus background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Lycus backend is older than this desktop build and may not work correctly. Update to align them.',
    updateLycus: 'Update Lycus',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Lycus Desktop.',
    ...
    native: {
      ...
      inputBody: 'Lycus is waiting for your response.',
      turnDoneTitle: 'Lycus finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Lycus defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Lycus is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Lycus asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Lycus was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Lycus follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Lycus checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Lycus configuration...',
    ...
    gateway: {
      ...
      intro:
        'Lycus Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Lycus backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Lycus backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Lycus backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /lycus.',
      ...
      restartingMessage: 'Lycus Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Lycus ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Lycus runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Lycus desktop' },
    ...
    lycusActiveSessions: (version, count) => `Lycus ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@lycus:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Lycus environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Lycus will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Lycus...',
    placeholderReconnecting: 'Reconnecting to Lycus…',
    ...
    attachUrlDesc: 'Lycus will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Lycus can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Lycus from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Lycus will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Lycus updater will take over in its own window and reopen Lycus when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Lycus reconnects automatically when it’s back.',
    applyingClose: 'Lycus will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Lycus needs a one-time install',
    ...
    settingUpTitle: 'Setting up Lycus Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Lycus CLI or desktop instance is running. Stop any running Lycus instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Lycus installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Lycus Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Lycus is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Lycus…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Lycus',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Lycus at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Lycus connects automatically',
      loopback: 'Opens your browser to sign in — Lycus connects automatically',
    ...
    authorizeThere: 'Authorize Lycus there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Lycus there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Lycus inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Lycus will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Lycus is restarting...',
      askRestart: 'Ask Lycus to restart the server',
      lookingRestart: taskId => `Lycus is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Lycus is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Lycus finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Lycus could not restart the server.',
      stillWorking:
        'Lycus is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Lycus is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Lycus gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.autolycus/config.yaml). Lycus won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Lycus needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Lycus needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Lycus Desktop to use Save Image.',
    restartToSaveImages: 'Restart Lycus Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `lycus gateway` running?'
    }
  },
