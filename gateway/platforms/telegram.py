...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _thread_kwargs_for_send(
        ...
        metadata. Lycus-created private-chat topic lanes are marked with
    ...
    # older PTB/clients. Streaming edits stay on Lycus' existing MarkdownV2
    ...
    def _has_telegram_desktop_details_math_crash_shape(self, content: str) -> bool:
        ...
        Lycus must skip rich delivery up front and use the legacy MarkdownV2
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        # has been killed (e.g. during `lycus update` or `--replace` handoffs)
        ...
        message = (
            ...
            "To recover: ensure no other Lycus or OpenClaw instance is running "
            "with this token, then restart the gateway with 'lycus gateway restart'."
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # readable by the Lycus process (shared mount, same machine, etc.).
            ...
            try:
                ...
                from lycus_cli.commands import telegram_menu_commands
    ...
    def _build_provider_keyboard(self, providers: list):
        ...
        CLI ``lycus model`` picker via the shared ``group_providers`` fold,
        so all surfaces stay consistent.
        """
        try:
            from lycus_cli.models import group_providers
        except Exception:
    ...
    async def _handle_model_picker_callback(
        ...
        if data.startswith("mp:"):
            ...
            group_id = data[4:]
            try:
                from lycus_cli.models import PROVIDER_GROUPS
    ...
    # Scripts live in ~/.autolycus/scripts/gmail-triage/. `arg` from the callback
    ...
    async def _handle_gmail_triage_callback(
        ...
        *,
        ...
        script_path = _Path.home() / ".autolycus" / "scripts" / "gmail-triage" / script_name
    ...
    def _message_mentions_bot(self, message: Message) -> bool:
        ...
        # raw substring matches like "foo@lycus_bot.example" are not mentions
    ...
    def _explicit_bot_mentions_exclude_self(self, message: Message) -> bool:
        ...
        Telegram groups can contain several Lycus bot profiles. A message like
