...
Config: ~/.autolycus/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.autolycus/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_lycus_home()`` helper (AUTOLYCUS_HOME-aware and
...
RULES_FILE = get_lycus_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_lycus_home() / "feishu_comment_pairing.json"
