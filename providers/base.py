...
def _profile_user_agent() -> str:
    """Return a ``lycus-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from lycus_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"lycus-cli/{_ver}"
    except Exception:
        return "lycus-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # lycus-cli UA so the catalog endpoint is reachable.
