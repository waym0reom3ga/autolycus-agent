...
Data file: $AUTOLYCUS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_AUTOLYCUS_HOME = Path(os.environ.get("AUTOLYCUS_HOME", Path.home() / ".autolycus"))
DATA_DIR = _AUTOLYCUS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
