...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("lycus_cli.config.get_config_path", return_value=config_path), \
             patch("lycus_cli.config.ensure_lycus_home"):
    ...
    def test_ensure_lycus_home_sets_0700(self):
        home = Path(self.tmpdir) / ".autolycus"
        with patch("lycus_cli.config.get_lycus_home", return_value=home):
