...
The main() function in lycus_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `lycus -c model`
...
def _build_parser():
    """Build a minimal replica of the lycus top-level parser."""
