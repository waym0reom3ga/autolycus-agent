"""Tests for the kanban CLI surface (lycus_cli.kanban)."""
...
from lycus_cli import kanban as kc
...
def test_run_slash_session_filter(kanban_home):
    """`lycus kanban list --session <id>` filters by the originating
...
def test_board_override_is_isolated_per_concurrent_call(kanban_home, monkeypatch):
    ...
    parser = argparse.ArgumentParser(prog="lycus", add_help=False)
...
def test_kanban_in_autocomplete_table():
    from lycus_cli.commands import COMMANDS, SUBCOMMANDS
