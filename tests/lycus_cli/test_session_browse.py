"""Tests for the interactive session browser (`lycus sessions browse`).
...
from lycus_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """lycus sessions browse should be parseable."""
