"""Tests for `lycus chat --safe-mode` — pristine troubleshooting runs.
...
class TestSafeModeEnvWiring:
    ...
    def test_safe_mode_sets_all_gates(self):
        # Mirrors the cmd_chat logic in lycus_cli/main.py.
        class Args:
            safe_mode = True
...
class TestSafeModeParser:
    """--safe-mode must parse on both the root parser and `lycus chat`."""
