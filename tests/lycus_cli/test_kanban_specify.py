"""Tests for the specifier module + `lycus kanban specify` CLI surface.
...
from lycus_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `lycus kanban …` argparse surface directly."""
