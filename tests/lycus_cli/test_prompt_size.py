"""Tests for the ``lycus prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from lycus_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(lycus_home, memory_text="", user_text=""):
    mem_dir = lycus_home / "memories"
...
def _seed_skill(lycus_home, name, description):
    skill_dir = lycus_home / "skills" / "demo" / name
