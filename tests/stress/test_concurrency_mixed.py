...
def worker_loop(worker_id: int, lycus_home: str, result_file: str) -> None:
...
def reclaimer_loop(lycus_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="lycus_mixed_stress_")
    print(f"AUTOLYCUS_HOME = {home}")
