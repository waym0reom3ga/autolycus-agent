...
def test_env_scrub_lycus_allowlist_and_secret_blocks():
    from tools.code_execution_tool import _scrub_child_env

    env = {
        # operational allowlist → kept
        "AUTOLYCUS_HOME": "/h", "HERMES_PROFILE": "p",
    ...
    for kept in ("AUTOLYCUS_HOME", "HERMES_PROFILE", "HERMES_CONFIG", "HERMES_ENV", "PATH"):
...
def test_env_scrub_logs_dropped_lycus_vars(caplog):
    ...
    env = {
        "AUTOLYCUS_HOME": "/h",          # allowlisted → kept, not logged
    ...
    assert "AUTOLYCUS_HOME" in out and "PATH" in out
