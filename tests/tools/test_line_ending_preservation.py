...
@pytest.fixture
def lycus_home(monkeypatch, tmp_path):
    """Isolate AUTOLYCUS_HOME so the tests don't pollute the real config.
...
class TestPatchCRLFPreservation:
    def test_patch_on_crlf_file_stays_pure_crlf(self, lycus_home, tmp_path):
    ...
    def test_patch_on_lf_file_stays_lf(self, lycus_home, tmp_path):
    ...
    def test_patch_multiline_replacement_on_crlf(self, lycus_home, tmp_path):
...
class TestWriteFileCRLFPreservation:
    ...
    def test_new_file_written_as_is(self, lycus_home, tmp_path):
    ...
    def test_overwrite_lf_file_stays_lf(self, lycus_home, tmp_path):
