...
def test_import_loads_env_from_lycus_home(tmp_path, monkeypatch):
    home = tmp_path / ".autolycus"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-lycus-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-lycus-home"
