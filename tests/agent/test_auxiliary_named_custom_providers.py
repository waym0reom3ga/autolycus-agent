...
def _isolate(tmp_path, monkeypatch):
    """Redirect AUTOLYCUS_HOME and clear module caches."""
...
def _write_config(tmp_path, config_dict):
    """Write a config.yaml to the test AUTOLYCUS_HOME."""
    import yaml
    config_path = tmp_path / ".autolycus" / "config.yaml"
...
class TestResolveProviderClientMainAlias:
    ...
    def test_main_resolves_github_copilot_alias(self, tmp_path):
        ...
        with (
            patch("lycus_cli.auth.resolve_api_key_provider_credentials", return_value={
