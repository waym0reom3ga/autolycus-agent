...
The unit tests in tests/lycus_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned lycus-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/lycus")
from lycus_cli.service_manager import S6ServiceManager
