...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateLycus: "Mettre à jour Lycus",
    updatingLycus: "Mise à jour de Lycus…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Lycus (parité avec `lycus plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.autolycus/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.autolycus/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.autolycus/skills/",
  ...
  config: {
    configPath: "~/.autolycus/config.yaml",
    filters: "Filtres",
    sections: "Sections",
  ...
  achievements: {
    hero: {
      ...
      title: "Lycus Achievements",
      subtitle:
        "Badges Lycus à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Lycus en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Lycus davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Lycus détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Lycus analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Lycus Agent ☤",
    },
  },
  kanban: {
