...
export const zhHant: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "探索、安裝、啟用並更新 Lycus 外掛（對齊 `lycus plugins` CLI）。",
    ...
    removeConfirm: "從 ~/.autolycus/plugins/ 移除此外掛？",
    removeHint: "僅可移除位於 ~/.autolycus/plugins 下使用者安裝的外掛。",
  ...
  skills: {
    ...
    categories: "分類",
    filters: "篩選",
    noSkills: "找不到技能。技能由 ~/.autolycus/skills/ 載入",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "從真實工作階段歷史中獲得的 Lycus 可收集徽章。已知尚未達成的成就會顯示為「已發現」；秘密成就在首次出現相符行為之前保持隱藏。",
      scan_subtitle:
        "正在掃描 Lycus 工作階段歷史。在歷史紀錄較多時，首次掃描可能需要 5–10 秒。",
    },
    actions: {
      rescan: "重新掃描",
    },
    ...
    guide: {
      ...
      secret_header: "秘密成就",
      secret_body:
        "秘密成就會隱藏其確切觸發條件。一旦 Lycus 偵測到相關訊號，卡片便會變為「已發現」並顯示其需求。",
      scan_status_header: "掃描狀態",
      scan_status_body:
        "Lycus 正在對本機歷史進行一次掃描，之後卡片會自動出現。即使需要幾秒鐘，也並未卡住。",
