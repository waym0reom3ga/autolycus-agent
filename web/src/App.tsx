...
const SIDEBAR_COLLAPSED_KEY = "lycus-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="lycus-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="lycus-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const { activeAction, isBusy, isRunning, pendingAction, runAction } =
    useSystemActions();
  const canUpdateLycus = status?.can_update_lycus === true;
  ...
  if (canUpdateLycus) {
    items.push({
      action: "update",
      icon: Download,
      label: t.status.updateLycus,
      runningLabel: t.status.updatingLycus,
      spin: false,
    });
  }
