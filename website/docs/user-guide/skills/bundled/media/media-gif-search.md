...
Set your Tenor API key in your environment (add to `~/.autolycus/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/lycus-agent/blob/main/skills/media/gif-search/url)`
