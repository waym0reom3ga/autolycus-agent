---
title: "Lycus Agent — Configure, extend, or contribute to Lycus Agent"
...
Configure, extend, or contribute to Lycus Agent.
...
| Path | `skills/autonomous-ai-agents/lycus-agent` |
| Version | `2.1.0` |
...
Config: `~/.autolycus/config.yaml` (settings), `~/.autolycus/.env` (API keys).
