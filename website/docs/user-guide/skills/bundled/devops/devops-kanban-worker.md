---
title: "Kanban Worker — Pitfalls, examples, and edge cases for Lycus Kanban workers"
sidebar_label: "Kanban Worker"
description: "Pitfalls, examples, and edge cases for Lycus Kanban workers"
---
...
Pitfalls, examples, and edge cases for Lycus Kanban workers. The lifecycle itself is auto-injected into every worker's system prompt as KANBAN_GUIDANCE (from agent/prompt_builder.py); this skill is what you load when you want deeper detail on specific scenarios.
