...
Migrate a user's OpenClaw customization footprint into Lycus Agent. Imports Lycus-compatible memories, MASK.md, command allowlists, user skills, and selected workspace assets from ~/.openclaw, then reports exactly what could not be migrated and why.
