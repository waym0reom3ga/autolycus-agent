...
| | |
|---|---|
| Source | Optional — install with `lycus skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Lycus Agent |
| License | MIT |
...
import upstream classes into Lycus itself.
...
Open `~/.autolycus/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Lycus core.
   Custom driver scripts under `~/.autolycus/skills/...` are user-side and fine.
