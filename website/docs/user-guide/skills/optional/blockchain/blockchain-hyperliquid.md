...
| | |
|---|---|
| Source | Optional — install with `lycus skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Lycus Agent |
| License | MIT |
...
The script reads `~/.autolycus/.env` for two optional defaults:
...
Helper script: `~/.autolycus/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.autolycus/.env`.
