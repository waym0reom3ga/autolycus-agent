...
| | |
|---|---|
| Source | Optional — install with `lycus skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Lycus Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.autolycus/.env`:
