...
| | |
|---|---|
| Source | Optional — install with `lycus skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.autolycus/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.autolycus/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Lycus installs package this)
