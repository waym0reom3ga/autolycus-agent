...
- User wants **Lycus itself to drive a browser** → use Lycus' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
