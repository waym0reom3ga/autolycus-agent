---
title: "Lycus S6 Container Supervision"
sidebar_label: "Lycus S6 Container Supervision"
description: "Modify, debug, or extend the s6-overlay supervision tree inside the Lycus Agent Docker image — adding new services, debugging profile gateways, understandin..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Lycus S6 Container Supervision

Modify, debug, or extend the s6-overlay supervision tree inside the Lycus Agent Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `lycus skills install official/devops/lycus-s6-container-supervision` |
| Path | `optional-skills/devops/lycus-s6-container-supervision` |
| Version | `1.0.0` |
| Author | Lycus Agent |
| License | MIT |
| Platforms | linux |
| Tags | `docker`, `s6`, `supervision`, `gateway`, `profiles` |
| Related skills | [`lycus-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-lycus-agent), `lycus-agent-dev` |
