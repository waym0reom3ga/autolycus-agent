...
description: "Connect Lycus Agent to WeCom via the AI Bot WebSocket gateway"
---

# WeCom (Enterprise WeChat)

Connect Lycus to [WeCom](https://work.weixin.qq.com/) (企业微信), Tencent's enterprise messaging platform. The adapter uses WeCom's AI Bot WebSocket gateway for real-time bidirectional communication — no public endpoint or webhook needed.
...
Select **WeCom** and scan the QR code with your WeCom mobile app. Lycus will automatically create a bot application with the correct permissions and save the credentials.
...
5. Run `lycus gateway setup`, select **WeCom**, and enter the credentials when prompted
