#!/usr/bin/env python3
"""Build the Lycus Model Catalog — a centralized JSON manifest of curated models.
...
Lycus CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Lycus release.
...
# Ensure AUTOLYCUS_HOME is set for imports that touch it at module level.
os.environ.setdefault("AUTOLYCUS_HOME", os.path.join(os.path.expanduser("~"), ".autolycus"))

from lycus_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "lycus-agent repo",
            "docs": "https://lycus-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
