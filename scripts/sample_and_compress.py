...
DEFAULT_DATASETS = [
    ...
    "NousResearch/lycus-agent-megascience-sft1",
    "NousResearch/Lycus-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Lycus-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-lycus-agent"
]
