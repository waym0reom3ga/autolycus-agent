...
VERSION_FILE = REPO_ROOT / "lycus_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "274096618+lycus-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "lycus@nousresearch.com": "NousResearch",
    ...
    "lycus@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "github@nadyalycus.anonaddy.com": "ruangraung",  # PR #42308
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (AUTOLYCUS_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: lycus-eval community link)
    ...
    "lycusagent26@gmail.com": "lycusagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+lycusagent26@users.noreply.github.com": "lycusagent26",
    ...
    "vigo@lycus": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.autolycus@agentmail.to": "oseftg",
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Lycus runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level AUTOLYCUS_HOME state files)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Lycus
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"lycus-agent[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "lycus@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/lycus-agent",
    ...
    lines.append(f"# Autolycus v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Autolycus. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Autolycus Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Autolycus Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Autolycus v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Autolycus v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Autolycus v{new_version} ({calver_date})' "
