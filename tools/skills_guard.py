...
Trust levels:
  - builtin:   Ships with Lycus. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.autolycus/\.env|\~/\.autolycus/\.env',
     "lycus_env_access", "critical", "exfiltration",
     "directly references Lycus secrets file"),
    ...
    (r'\.autolycus/config\.yaml|\.autolycus/SOUL\.md',
     "lycus_config_mod", "critical", "persistence",
     "references Lycus configuration files directly"),
...
# scan. `.skillignore` is the Lycus-native name; `.clawhubignore` is honored
