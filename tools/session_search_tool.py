...
the get_anchored_view / get_messages_around primitives in lycus_state.
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from lycus_state import DEFAULT_DB_PATH
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Lycus profile's database "
