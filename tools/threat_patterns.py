...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'\$HOME/\.autolycus/\.env|\~/\.autolycus/\.env', "lycus_env", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*(?:AGENTS\.md|CLAUDE\.md|\.cursorrules|\.clinerules)', "agent_config_mod", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*\.autolycus/(config\.yaml|SOUL\.md)', "lycus_config_mod", "strict"),
