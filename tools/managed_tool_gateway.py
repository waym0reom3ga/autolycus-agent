...
def auth_json_path():
    """Return the Lycus auth store path, respecting AUTOLYCUS_HOME overrides."""
    return get_lycus_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`lycus tools`, banner/status paint, provider
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from lycus_cli.auth import resolve_nous_access_token
