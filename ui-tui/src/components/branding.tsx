import { Box, Text, useStdout } from '@lycus/ink'
...
const TAG_FULL = 'Technetia Inc · Autonomous AI Agent'
const TAG_MID = 'Autonomous AI Agent'
const TAG_TINY = 'Technetia Inc'
const HIDE_BELOW = 34
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · Technetia Inc</Text>
          </Text>
      ...
      <Box flexDirection="column" width={w}>
        ...
        {typeof info.update_behind === 'number' && info.update_behind > 0 && (
          <Text bold color={t.color.warn}>
            ...
            <Text bold color={t.color.warn}>
              {info.update_command || 'autolycus update'}
            </Text>
            <Text bold={false} color={t.color.warn} dimColor>
              {' '}
              to update
