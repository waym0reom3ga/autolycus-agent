...
//
// Both gate on HERMES_DEV_PERF=1 and dump JSON-lines (default ~/.autolycus/perf.log,
...
import { scrollFastPathStats } from '@lycus/ink'
...
const LOG_PATH = process.env.HERMES_DEV_PERF_LOG?.trim() || join(homedir(), '.autolycus', 'perf.log')
