# Streaming LLM Response Support for Lycus Agent
...
```
LYCUS_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("LYCUS_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `lycus_cli/config.py` | 1 | +streaming config defaults |
