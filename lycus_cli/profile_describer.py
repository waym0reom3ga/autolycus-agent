...
Used by ``lycus profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``lycus_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Lycus Agent kanban board.
...
Rules:
  ...
  - Never write "Lycus Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_lycus_home())
        else:
