"""
Lycus CLI - Unified command-line interface for Lycus Agent.

Provides subcommands for:
- lycus chat          - Interactive chat (same as ./lycus)
...
def _ensure_utf8():
    ...
    can even start — e.g. `lycus setup` on a fresh Pi.
    ...
    lycus_cli/stdio.py::configure_windows_stdio() runs later from the entry
