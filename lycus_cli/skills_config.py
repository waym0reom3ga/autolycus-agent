"""
Skills configuration for Lycus Agent.
`lycus skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.autolycus/config.yaml under:
...
from lycus_cli.config import cfg_get, load_config, save_config
from lycus_cli.colors import Colors, color
from lycus_cli.platforms import PLATFORMS as _PLATFORMS
