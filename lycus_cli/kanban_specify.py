...
Used by ``lycus kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``lycus_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Autolycus board.
...
def _profile_author() -> str:
    """Mirror of ``lycus_cli.kanban._profile_author``. Kept local to
