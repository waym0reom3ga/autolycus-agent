...
Entry point: ``lycus whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``lycus_cli/main.py``).
...
Lycus gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Lycus to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Lycus needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Lycus gateway in another terminal:")
    print("         lycus gateway")
    print()
    ...
    print()
    print("  Docs: https://lycus-agent.nousresearch.com/docs/user-guide/")
