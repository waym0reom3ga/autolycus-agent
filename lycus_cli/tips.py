...
TIPS = [
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Lycus your own.",
    ...
    "lycus profile create backup --clone-all copies everything (config, keys, SOUL.md, memories, skills, sessions).",
