...
Invoked by ``lycus kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Lycus Agent board.
...
def _profile_author() -> str:
    """Mirror of ``lycus_cli.kanban._profile_author``."""
    return (
