...
def build_login_parser(subparsers, *, cmd_login: Callable) -> None:
    ...
    login_parser = subparsers.add_parser(
        ...
        description="Run OAuth device authorization flow for Lycus CLI",
    )
    ...
    login_parser.add_argument(
        "--client-id", default=None, help="OAuth client id to use (default: lycus-cli)"
    )
