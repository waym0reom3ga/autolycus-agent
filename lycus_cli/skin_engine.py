"""Lycus CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.autolycus/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Lycus Agent"          # Banner title, status display
...
.. code-block:: python
    ...
    from lycus_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Lycus Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.autolycus/skins/
...
Drop a YAML file in ``~/.autolycus/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces LYCUS_AGENT_LOGO)
