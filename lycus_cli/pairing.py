...
Usage:
    lycus pairing list              # Show all pending + approved users
    lycus pairing approve <platform> <code>  # Approve a pairing code
    lycus pairing revoke <platform> <user_id> # Revoke user access
    lycus pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle lycus pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: lycus pairing {list|approve|revoke|clear-pending}")
        print("Run 'lycus pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.autolycus/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'lycus pairing list' to see pending codes.\n")
